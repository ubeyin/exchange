  ...
  if ($("#search").val()) {
    ...
    .then(function(response) {
      ...
      for (var i = 0; i < response.query.search.length; i++) {
        results += '<tr><td style="min-width:120px"><p>'+response.query.search[i].title+'</p></td><td><p>'+response.query.search[i].snippet+'....<br><a href= "http://en.wikipedia.org/wiki?curid='+response.query.search[i].pageid+'" target="_parent"> Read more </a></p></td> </tr>'+"<br><br>";
      }
